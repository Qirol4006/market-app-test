  ...
  <div class="content">
    ...
    <form class="navbar-form">
      ...
      <div class="container-fluid">
        <div class="card">
        <div class="card-header content-center" id="headingOne">
          <h2 class="mb-0">
...
export default {
  ...
  async created() {
    ...
    document.title = this.$route.params.name + " | Market App"
  },

  methods:{
    thirdLevel(id){
      this.$router.push('/categories/' + this.$route.params.id + '/' + id)
    },
